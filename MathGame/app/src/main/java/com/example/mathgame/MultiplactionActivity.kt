...
import com.example.mathgame.databinding.ActivityMultiplactionBinding
import java.util.Locale
import kotlin.random.Random

class MultiplactionActivity : AppCompatActivity() {
    lateinit var gameBinding : ActivityMultiplactionBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        enableEdgeToEdge()
        gameBinding = ActivityMultiplactionBinding.inflate(layoutInflater)
        ...
        gameBinding.buttonNext.setOnClickListener {
            ...
            if (userLife == 0 && userAnswer != correctAnswer){
                ...
                val intent = Intent(this@MultiplactionActivity,ResultActivity::class.java)
